      ...
      <div className="auth-card">
        ...
        {step === 'forgot' && (
          <div className="auth-form animate-in">
            ...
            <button className="auth-btn auth-btn--primary" onClick={handleForgotPassword} disabled={loading}>
              {loading ? 'Sending...' : 'Send Reset Code →'}
            </button>
            <button className="auth-btn auth-btn--ghost" onClick={() => { setStep('login'); clearMessages(); }}>
              ← Back to login
            </button>
          </div>
        )}
        ...
        {step === 'reset' && (
          <div className="auth-form animate-in">
            ...
            <div className="auth-field">
              ...
              <input type="text" placeholder="Enter code from email" maxLength={6} value={resetCode}
            ...
            <button className="auth-btn auth-btn--primary" onClick={handleResetPassword} disabled={loading}>
              {loading ? 'Resetting...' : 'Reset Password →'}
            </button>
            <button className="auth-btn auth-btn--ghost" onClick={() => { setStep('forgot'); clearMessages(); }}>
              ← Back
            </button>
          </div>
        )}
